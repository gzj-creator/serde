#ifndef SERDE_TOML_HPP
#define SERDE_TOML_HPP
// serde TOML 实现头。经典 TU 直接 include；模块消费者经
// src/toml/toml.cppm 门面 import。
 ...
 * 结构化值，合法性会在解析或序列化时校验。实现位于 `common` 模块，
 * 经别名在本命名空间暴露。
 */
